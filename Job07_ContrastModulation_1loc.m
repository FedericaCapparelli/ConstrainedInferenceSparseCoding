function [a_cen, a_sur, b_cen, b_sur] = Job07_ContrastModulation_1loc(myseed, n, whichPop, typeStim, withlong)
% This routine executes the function ContrastModulation_1loc, which 
...
if ismember(n, index_sel)
    if exist(ResFileComplete, 'file')==2
        ...
        s = s_max(n);
        r = r_max(n);
        [a_cen, a_sur, b_cen, b_sur] = ContrastModulation_1loc(D, C, n, o, s, r, typeStim);
        %%% Save results
