function [ya, yb] = Job03_SizeTuning_1loc(myseed, s, r, withlong)
% This routine executes the function SizeTuning_1loc to get responses of all the
...
if exist(ResFileComplete, 'file')==2
    ...
    typeStim = 1;
    [ya, yb] = SizeTuning_1loc(D, C, s, r, typeStim);
    %%% Save results
    fprintf('\nSaving resuluts...\n')
