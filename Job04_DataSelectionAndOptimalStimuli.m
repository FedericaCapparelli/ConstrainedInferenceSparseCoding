function [index_sel, o_max, s_max, r_max, SI] = Job04_DataSelectionAndOptimalStimuli(myseed, whichPop)
...
CurrentFolder = pwd;
ResFolder = strcat(CurrentFolder, '/contextual_modulation_4locations/seed_', sprintf('%02.0f', myseed), '/Paradigm_1/'); pos = strfind(ResFolder, 'seed')-1;
