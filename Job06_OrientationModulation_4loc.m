function [an, bn] = Job06_OrientationModulation_4loc(myseed, n, whichPop, withlong)
% This routine executes the function OrientationModulation_4loc, which 
...
if ismember(n, index_sel)
    if exist(ResFileComplete, 'file')==2
        ...
        s = s_max(n);
        r = r_max(n);
        [an, bn] = OrientationModulation_4loc(D, C, V, n, o, s, r);
        %%% Save results
